...
- (UILabel *)useRuleLabel{
    if (!_useRuleLabel) {
        ...
        _useRuleLabel.textColor = KMainTextColor_3;
    }
...
- (UILabel *)useTimeLabel{
    if (!_useTimeLabel) {
        ...
        _useTimeLabel.textColor = KMainTextColor_9;
    }
...
- (instancetype)initWithData:(NSArray<WLKTCourseCouponData *> *)dataArray isGetCoupon:(BOOL)isGetCoupon couponIndex:(NSInteger)couponIndex Target:(UIViewController *)vc
{
    ...
    if (self) {
        ...
        self.frame = CGRectMake(0, 0, ScreenWidth, ScreenHeight -IphoneXBottomInsetHeight);
...
- (UIView *)tapBgView{
    if (!_tapBgView) {
        _tapBgView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight -IphoneXBottomInsetHeight)];
...
- (UIView *)contentView{
    if (!_contentView) {
        _contentView = [[UIView alloc]initWithFrame:CGRectMake(0, ScreenHeight -IphoneXBottomInsetHeight, ScreenWidth, 433 * ScreenRatio_6)];
