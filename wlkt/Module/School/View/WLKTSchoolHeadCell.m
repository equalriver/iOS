...
- (void)makeConstraints{
    ...
    [self.collectCountLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_equalTo(self.see_collectCount_bgView.mas_right).offset(-10 * ScreenRatio_6);
    }];
    ...
    [self.changdiIV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.contentView).offset(10 * ScreenRatio_6);
        make.top.mas_equalTo(self.yingIV.mas_bottom).offset(10 * ScreenRatio_6);
    }];
...
- (UILabel *)seeLabel{
    if (!_seeLabel) {
        ...
        _seeLabel.font = [UIFont systemFontOfSize:10 * ScreenRatio_6];
...
- (UILabel *)collectCountLabel{
    if (!_collectCountLabel) {
        ...
        _collectCountLabel.font = [UIFont systemFontOfSize:10 * ScreenRatio_6];
...
- (UILabel *)phoneLabel{
    if (!_phoneLabel) {
        ...
        _phoneLabel.textColor = KMainTextColor_3;
        _phoneLabel.font = [UIFont systemFontOfSize:11 * ScreenRatio_6];
