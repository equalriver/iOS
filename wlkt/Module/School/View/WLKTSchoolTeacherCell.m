...
#import "WLKTSchoolTeacherCell.h"

@interface WLKTSchoolTeacherCollectionCell: UICollectionViewCell
...
@implementation WLKTSchoolTeacherCollectionCell
...
/****************************************************************************/
@interface WLKTSchoolTeacherCell ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation WLKTSchoolTeacherCell
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    WLKTSchoolTeacherCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"WLKTSchoolTeacherCollectionCell" forIndexPath:indexPath];
...
- (UICollectionView *)contentCV{
    if (!_contentCV) {
        ...
        [_contentCV registerClass:[WLKTSchoolTeacherCollectionCell class] forCellWithReuseIdentifier:@"WLKTSchoolTeacherCollectionCell"];
    }
    return _contentCV;
}
