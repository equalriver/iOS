...
- (void)loadData{
    ...
    [api startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest *request) {
        ...
        h += [self.data.question getSizeWithWidth:ScreenWidth Font:15 *ScreenRatio_6].height;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    h += [self.dataArr[indexPath.row].answer getSizeWithWidth:ScreenWidth -20 Font:14].height;
