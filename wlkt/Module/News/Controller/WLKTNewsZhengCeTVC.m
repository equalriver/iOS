...
- (void)loadDataWithPage:(NSInteger)page{
    ...
    WLKTNewsApi *api = [[WLKTNewsApi alloc]initWithType:WLKTNewsTypeNews page:page newstag:@"政策"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat hhh = [self.dataArr[indexPath.row].title getSizeWithWidth:ScreenWidth - 20 Font:18.5].height;
