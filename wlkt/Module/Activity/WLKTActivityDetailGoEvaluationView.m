//
//  WLKTActivityDetailGoEvaluationView.m
//  wlkt
//
...
#define numberItemDefColor KMainTextColor_9
...
@interface WLKTActivityDetailGoEvaluationView ()<UITextViewDelegate>
...
@implementation WLKTActivityDetailGoEvaluationView
...
- (void)makeConstraints{
    ...
    [self.pingjiaTV mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(self.huanjingView.mas_bottom).offset(10 * ScreenRatio_6);
...
- (PlaceholderTextView *)pingjiaTV{
    if (!_pingjiaTV) {
        ...
        _pingjiaTV.myPlaceholder = @"活动怎么样？环境如何？还满意吗？(5~200个字)";
