...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGFloat questionHeight = [self.dataArr[indexPath.row].describe getSizeWithWidth:ScreenWidth - 20 Font:13.5].height;
    CGFloat answerHeight = 0;
    if (self.dataArr[indexPath.row].handlelist.count) {
        answerHeight = [self.dataArr[indexPath.row].handlelist[0].result getSizeWithWidth:340 * ScreenRatio_6 Font:13.5].height + 55;
    }
