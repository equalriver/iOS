...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (self.dataArr[indexPath.section].answerlist.count) {
        return 55 + [self.dataArr[indexPath.section].answerlist[indexPath.row].answer getSizeWithWidth:315 * ScreenRatio_6 Font:13.5].height;
    }
    return 0;
}

- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    return 55 + [self.dataArr[section].question getSizeWithWidth:275 * ScreenRatio_6 Font:13.5].height;
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    WLKTActivityDetail_Q_A_2_headerQuestionView *v = [[WLKTActivityDetail_Q_A_2_headerQuestionView alloc]initWithIndex:section frame:CGRectMake(0, 0, ScreenWidth, 55 + [self.dataArr[section].question getSizeWithWidth:275 * ScreenRatio_6 Font:13.5].height)];
    v.delegate = self;
