//
//  WLKTActivityDetailLocationCell.m
//  wlkt
//
...
@interface WLKTActivityDetailLocationCell ()
...
@implementation WLKTActivityDetailLocationCell
...
- (void)setCellData:(WLKTActivity *)data currentCoordinate:(CLLocationCoordinate2D)currentCoordinate{
    self.schoolNameLabel.text = data.shortaddress;
