...
- (void)setupViews{
    ...
    course_1.textColor = KMainTextColor_3;
    course_1.text = @"课程合作";
    ...
    course_2.textColor = KMainTextColor_9;
    ...
    user.textColor = KMainTextColor_3;
    user.text = @"联系人";
    [bg addSubview:user];
    ...
    phone.textColor = KMainTextColor_3;
    phone.text = @"联系电话";
    [bg addSubview:phone];
    ...
    other.textColor = KMainTextColor_3;
    other.text = @"备注";
    [bg addSubview:other];
...
- (UITextField *)usenameTF{
    if (!_usenameTF) {
        ...
        _usenameTF.textColor = KMainTextColor_3;
...
- (PlaceholderTextView *)otherTV{
    if (!_otherTV) {
        _otherTV = [[PlaceholderTextView alloc]initWithPlaceholderColor:KMainTextColor_9 font:12 * ScreenRatio_6];
        _otherTV.myPlaceholder = @"你想说的话...";
//        _otherTV.layer.borderColor = KMainTextColor_9.CGColor;
//        _otherTV.layer.borderWidth = 0.5;
        _otherTV.font = [UIFont systemFontOfSize:12 * ScreenRatio_6];
        _otherTV.textColor = KMainTextColor_3;
    }
    return _otherTV;
}
- (UIButton *)confirmBtn{
