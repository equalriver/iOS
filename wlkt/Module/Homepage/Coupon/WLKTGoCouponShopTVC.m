...
- (void)ruleButtonAct:(UIButton *)sender{
    UIView *v = [WLKTMyCouponTools makeUseRuleAlertViewWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight -IphoneXBottomInsetHeight)];
...
- (UILabel *)totalLabel{
    if (!_totalLabel) {
        ...
        _totalLabel.textColor = KMainTextColor_9;
