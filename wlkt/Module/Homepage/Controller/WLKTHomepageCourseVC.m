...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.dataArr[indexPath.row].coursename getSizeWithWidth:210 *ScreenRatio_6 Font:17 *ScreenRatio_6].height > 25 *ScreenRatio_6) {
