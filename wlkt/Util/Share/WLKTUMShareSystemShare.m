...
#import "WLKTUMShareSystemShare.h"

@implementation WLKTUMShareSystemShare
+(void)load
{
    [super load];
}
...
{
    return @[@(UMSocialPlatformType_UserDefine_Begin +2)];
}


+ (WLKTUMShareSystemShare *)defaultManager
{
    static WLKTUMShareSystemShare *instance = nil;
...
-(void)umSocial_ShareWithObject:(UMSocialMessageObject *)messageObject withCompletionHandler:(UMSocialRequestCompletionHandler)completionHandler{
    !completionHandler ?: completionHandler(@"systemShare", nil);
}
