//
//  WLKTBaseNaviController.m
//  wlkt
//
//  Created by nanbojiaoyu on 2018/2/2.
...
@interface WLKTBaseNaviController ()<UIGestureRecognizerDelegate, UINavigationControllerDelegate>
...
@implementation WLKTBaseNaviController
- (void)viewDidLoad{
    [super viewDidLoad];
