...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    CGFloat h = 70;
    CGFloat h1 = [self.dataArr[indexPath.section].describe getSizeWithWidth:ScreenWidth -20 Font:13].height;
    h += h1 > 35 ? 30 : h1;
...
//    }
    if (self.dataArr[indexPath.section].handlelist) {
        CGFloat hh = [self.dataArr[indexPath.section].handlelist.result getSizeWithWidth:ScreenWidth -40 Font:13].height;
        h += hh > 35 ? 30 : hh;
        h += 35;
    }
    return h;
