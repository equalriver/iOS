...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event{
    ...
    if (CGRectContainsPoint(statusBarFrame, touchLocation)){//点击状态栏
        [[NSNotificationCenter defaultCenter]postNotificationName:kTouchStatusBarNoti object:nil];
    }
}
...
- (void)appReceiveRemoteNotification:(NSDictionary *)userInfo{
    ...
    if ([keys containsObject:@"message"]) {
        ...
        vc = [[WLKTCDPageController alloc]initWithCourseId:userInfo[@"coursedetail"]];
