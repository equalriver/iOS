...
//    self.locationLabel.text = model.shortaddress;
    ...
    self.timeLabel.textColor = KMainTextColor_9;
    self.locationLabel.textColor = KMainTextColor_9;
    self.contentLabel.textColor = KMainTextColor_9;
    ...
    self.chargeLabel.textColor = kMainTextColor_red;
