...
//        _classroomNavigationController = [[WLKTBaseNaviController alloc] initWithRootViewController:[[WLKTClassroomVC alloc] init]];
        _classroomNavigationController = [[WLKTBaseNaviController alloc] initWithRootViewController:[[WLKTLiveVideoVC alloc] init]];
    }
...
- (UIImage *)tabDefaultImageAtIndex:(NSInteger)index {
    switch (index) {
        case 0: return [UIImage imageNamed:@"tab_1"];
        case 1: return [UIImage imageNamed:@"tab_2"];
        case 2: return [UIImage imageNamed:@"tab_3"];
    }
    return [UIImage imageNamed:@"tab_4"];
}

- (UIImage *)tabSelectedImageAtIndex:(NSInteger)index {
    switch (index) {
        case 0: return [UIImage imageNamed:@"tab_1_select"];
        case 1: return [UIImage imageNamed:@"tab_2_select"];
        case 2: return [UIImage imageNamed:@"tab_3_select"];
    }
    return [UIImage imageNamed:@"tab_4_select"];
}
