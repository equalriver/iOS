...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    CGFloat h = [self.dataArr[section].question getSizeWithWidth:ScreenWidth - 50 *ScreenRatio_6 Font:16 *ScreenRatio_6].height;
...
- (UIView *)footerView{
    if (!_footerView) {
        _footerView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenWidth, 520 *ScreenRatio_6 + IphoneXBottomInsetHeight)];
