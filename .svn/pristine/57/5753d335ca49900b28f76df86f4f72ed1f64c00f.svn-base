...
#import "WLKTUMShareCopyHandler.h"

@implementation WLKTUMShareCopyHandler
+(void)load
{
    [super load];
}
...
+ (WLKTUMShareCopyHandler *)defaultManager
{
    static WLKTUMShareCopyHandler *instance = nil;
...
-(void)umSocial_ShareWithObject:(UMSocialMessageObject *)messageObject withCompletionHandler:(UMSocialRequestCompletionHandler)completionHandler{
    !completionHandler ?: completionHandler(@"copy", nil);
}
