...
- (void)setBarButtonItem{
    ...
    UIBarButtonItem *more = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"更多h"] style:UIBarButtonItemStylePlain target:self action:@selector(moreBarButtonAct:)];
    [search setImageInsets:UIEdgeInsetsMake(0, 10 *ScreenRatio_6, 0, -10 *ScreenRatio_6)];
