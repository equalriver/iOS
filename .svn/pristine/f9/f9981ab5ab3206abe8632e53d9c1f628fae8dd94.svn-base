...
#import "WLKTLivePaySuccessVC.h"
#import "WLKTLogin.h"
#import "WLKTUnPayCourseTVC.h"
#import "AppDelegate.h"

@interface WLKTLivePaySuccessVC ()

@end

@implementation WLKTLivePaySuccessVC
...
- (void)orderButtonAct:(UIButton *)sender{
    ...
    [self.navigationController pushViewController:[[WLKTUnPayCourseTVC alloc]init] animated:YES];
    //[self presentViewController:[[WLKTPayCourseTVC alloc]init] animated:YES completion:nil];
}
