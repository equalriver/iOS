...
@interface NTESBaseVC ()<YYTextKeyboardObserver, UITextFieldDelegate>
...
- (void)configNavigationBar {
    UIImage *backImg = [UIImage imageWithColor:UIColorHex(f7f7f9) size:CGSizeMake(100, 100)];
...
- (UIButton *)leftButton
{
    if (!_leftButton)
    {
        ...
        if (self.leftBtnTitleColor) {
            ...
            [_leftButton setTitleColor:UIColorHex(238EFA) forState:UIControlStateNormal];
        }
...
- (UIButton *)rightButton
{
    if (!_rightButton)
    {
        ...
        [_rightButton setTitleColor:UIColorHex(238EFA) forState:UIControlStateNormal];
...
#pragma mark -- 子类重载
- (void)doKeyboardChangedWithTransition:(YYTextKeyboardTransition)transition {}
