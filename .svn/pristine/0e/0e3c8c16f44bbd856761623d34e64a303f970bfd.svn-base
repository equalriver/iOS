...
#import "WLKTSchoolBottomBtns.h"

@interface WLKTSchoolBottomBtns ()
...
@implementation WLKTSchoolBottomBtns
...
- (void)btnDidClick:(UIButton *)sender{
    if ([self.delegate respondsToSelector:@selector(schoolBottomButtonDidSelectedButton:)]) {
        [self.delegate schoolBottomButtonDidSelectedButton:sender];
    }
}
...
- (UIButton *)appointmentBtn{
    if (!_appointmentBtn) {
        ...
        _appointmentBtn.titleLabel.font = [UIFont systemFontOfSize:14 weight:UIFontWeightSemibold];
