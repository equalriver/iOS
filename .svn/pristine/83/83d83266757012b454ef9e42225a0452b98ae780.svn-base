...
- (void)setCellData:(WLKTSchoolNewsList *)data{
    ...
    if (type == SchoolNewsContainVideo) {
        ...
        [self.titleLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.mas_equalTo(self.contentView).offset(15 *ScreenRatio_6);
            make.left.mas_equalTo(self.videoIV.mas_right).offset(10 *ScreenRatio_6);
        }];
...
- (void)makeConstraints{
    ...
    [self.readIV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.contentView).offset(10 *ScreenRatio_6);
        make.bottom.mas_equalTo(self.separatorView).offset(-10 *ScreenRatio_6);
    }];
    ...
    [self.likeIV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.readLabel.mas_right).offset(15 *ScreenRatio_6);
        make.centerY.mas_equalTo(self.readIV);
    }];
    ...
    [self.commentIV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(self.likeLabel.mas_right).offset(20 *ScreenRatio_6);
        make.centerY.mas_equalTo(self.readIV);
    }];
    ...
    [self.detailLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(self.readLabel.mas_top).offset(-10 *ScreenRatio_6);
        make.left.mas_equalTo(self.contentView).offset(10 *ScreenRatio_6);
        make.right.mas_equalTo(self.contentView.mas_right).offset(-10 *ScreenRatio_6);
    }];
}
...
- (UILabel *)readLabel{
    if (!_readLabel) {
        ...
        _readLabel.font = [UIFont systemFontOfSize:12 *ScreenRatio_6];
        _readLabel.textColor = KMainTextColor_9;
    }
    return _readLabel;
}
- (UIImageView *)likeIV{
...
- (UILabel *)likeLabel{
    if (!_likeLabel) {
        ...
        _likeLabel.font = [UIFont systemFontOfSize:12 *ScreenRatio_6];
        _likeLabel.textColor = KMainTextColor_9;
    }
    return _likeLabel;
