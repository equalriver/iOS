...
@interface WLKTClassifyVC ()//<CLLocationManagerDelegate, WMPageControllerDelegate, WMPageControllerDataSource, UIScrollViewDelegate, ClassifyHeadNaviDelegate, WLKTClassifyFliterBtnsDelegate>
...
//    return CGRectMake(0, 40, kScreenWidth, kScreenHeight - NavigationBarAndStatusHeight - 40 -100);
//}
//
//- (void)pageController:(WMPageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info{
//    if (self.pageController.selectIndex == 0) {//course
